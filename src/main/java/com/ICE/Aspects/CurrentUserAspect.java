...
//    @Pointcut("execution(* com.ICE.controllers.FacultyController.*(..)) && args(model,p,..)")
//    private void forFacultyController(){}
//
//    @Pointcut("execution(* com.ICE.controllers.StudentController.*(..)) && args(model,p,..)")
//    private void forStudentController(){}
//
//
//    @Before("forFacultyController() || forStudentController()")
